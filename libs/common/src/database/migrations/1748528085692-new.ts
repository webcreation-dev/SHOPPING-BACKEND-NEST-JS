...
export class New1748528085692 implements MigrationInterface {
    name = 'New1748528085692'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."payment_type_enum" AS ENUM('PAYMENT', 'ADVANCE', 'WITHDRAWAL')
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."payment_method_enum" AS ENUM('WALLET', 'MTN')
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."payment_status_enum" AS ENUM('PENDING', 'FAILED', 'SUCCESSFUL')
        `);
        await queryRunner.query(`
        ...
        `);
        await queryRunner.query(`
            CREATE TYPE "public"."status_contract_enum" AS ENUM('PENDING', 'ACTIVE', 'FINISHED', 'SUSPENDED')
        `);
        await queryRunner.query(`
            CREATE TABLE "contract" (
                ...
                "is_gerant_locapay" boolean NOT NULL DEFAULT false,
                "propertyId" integer,
                "landlordId" integer,
                "tenantId" integer,
                "created_at" TIMESTAMP NOT NULL DEFAULT now(),
        ...
        await queryRunner.query(`
            ALTER TABLE "transaction"
            ADD CONSTRAINT "FK_d246554c12d32ef78934bdc6abd" FOREIGN KEY ("contractId") REFERENCES "contract"("id") ON DELETE NO ACTION ON UPDATE NO ACTION
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE "transaction" DROP CONSTRAINT "FK_d246554c12d32ef78934bdc6abd"
        `);
        await queryRunner.query(`
