...
export class New1744683648516 implements MigrationInterface {
    name = 'New1744683648516'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            CREATE TABLE "due" (
                ...
                "invoice_water" integer NOT NULL DEFAULT '0',
                "invoice_electricity" integer NOT NULL DEFAULT '0',
